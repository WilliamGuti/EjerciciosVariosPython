...
# les cobra por peso de cada paquete así que deben calcular 
...
PesoPayasos = 112
PesoMugniecas = 75
payasosVendidos = int(input("Ingresa la cantidad de payasos vendidos: "))
mugniecasVendidas = int(input("Ingresa la cantidad de muñecas vendidas: "))
pesoTotal = ((payasosVendidos*PesoPayasos) + (mugniecasVendidas*PesoMugniecas))
